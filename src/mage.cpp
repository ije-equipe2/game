...
Mage::heavy_attack()
{
    audio::play_sound_effect("/usr/share/deadly_wish/sound/fx/mago_heavy.ogg", EFFECTS_VOLUME, 0);
    auto p = parent();
    printf("p = %p\n", (void *) p);
...
void
Mage::light_attack() {
    audio::play_sound_effect("/usr/share/deadly_wish/sound/fx/mago_light.ogg", EFFECTS_VOLUME, 0);
    auto p = parent();
    printf("p = %p\n", (void *) p);
...
void
Mage::defense() {
    audio::play_sound_effect("/usr/share/deadly_wish/sound/fx/mago_block.ogg", EFFECTS_VOLUME, 0);
    change_character_state(DEFENSE_STATE);
}

void
Mage::special() {
    audio::play_sound_effect("/usr/share/deadly_wish/sound/fx/mago_ultimate.ogg", EFFECTS_VOLUME, 0);
    auto p = parent();
    printf("p = %p\n", (void *) p);
