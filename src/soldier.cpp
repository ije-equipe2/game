...
{
    audio::play_sound_effect("/usr/share/deadly_wish/sound/fx/soldier_heavy.ogg", EFFECTS_VOLUME, 0);
    auto p = parent();
    printf("p = %p\n", (void *) p);
...
Soldier::light_attack() {
    audio::play_sound_effect("/usr/share/deadly_wish/sound/fx/soldier_light.ogg", EFFECTS_VOLUME, 0);
    auto p = parent();
    printf("p = %p\n", (void *) p);
...
void
Soldier::defense() {
    audio::play_sound_effect("/usr/share/deadly_wish/sound/fx/soldier_block.ogg", EFFECTS_VOLUME, 0);
    change_character_state(DEFENSE_STATE);
}

void
Soldier::special() {
    audio::play_sound_effect("/usr/share/deadly_wish/sound/fx/soldier_ultimate.ogg", EFFECTS_VOLUME, 0);
