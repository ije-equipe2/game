    ...
    : m_game(title, w, h, scale), m_engine(), m_level_factory()
{
    ...
    resources::set_textures_dir("/usr/share/deadly_wish/images");
    resources::set_fonts_dir("/usr/share/deadly_wish/fonts");
    audio::set_audio_dir("/usr/share/deadly_wish/sound");
