...
Character::update_self(unsigned now, unsigned last)
{
    ...
    if(now - m_last_sound_played > 400) {
        ...
        switch(m_character_code) {
            case KNIGHT:
                audio::play_sound_effect("/usr/share/deadly_wish/sound/fx/pesadao_run.ogg", 30, 0);
                break;

            case INFILTRATOR:
                audio::play_sound_effect("/usr/share/deadly_wish/sound/fx/infiltrador_run.ogg", 30, 0);
                break;

            case MAGE:
                audio::play_sound_effect("/usr/share/deadly_wish/sound/fx/mago_run.ogg", 30, 0);
                break;

            case SOLDIER:
                audio::play_sound_effect("/usr/share/deadly_wish/sound/fx/soldier_run.ogg", 30, 0);
                break;
        }
    }
