...
Knight::heavy_attack()
{
    audio::play_sound_effect("/usr/share/deadly_wish/sound/fx/pesadao_heavy.ogg", EFFECTS_VOLUME, 0);
    change_character_state(HEAVY_ATTACK_STATE);
}

void
Knight::light_attack() {
    audio::play_sound_effect("/usr/share/deadly_wish/sound/fx/pesadao_light.ogg", EFFECTS_VOLUME, 0);
    auto p = parent();
    printf("p = %p\n", (void *) p);
...
void
Knight::defense() {
    audio::play_sound_effect("/usr/share/deadly_wish/sound/fx/pesadao_block.ogg", EFFECTS_VOLUME, 0);
